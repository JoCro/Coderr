...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('coderr_app', '0007_offerdetail_features_offerdetail_offer_type_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'pending'), ('in_progress', 'in_progress'), ('delivered', 'delivered'), ('cancelled', 'cancelled')], default='in_progress', max_length=20)),
